...
function normalizeFortType($type) {
    ...
    $typeMap = [
        ...
        'sea fort' => 'Sea Forts',
        'sea forts' => 'Sea Forts',
        'coastal fort' => 'Coastal Forts',
        'coastal forts' => 'Coastal Forts',
        'coast fort' => 'Coastal Forts',
        ...
        'forest fort' => 'Forest Forts',
        'forest forts' => 'Forest Forts',
        'jungle fort' => 'Forest Forts'
    ];
...
$categoryInfo = [
    ...
    'Sea Forts' => [
        'description' => 'Island forts built on rocky outcrops in the Arabian Sea',
        'icon' => 'fas fa-anchor',
        'difficulty_range' => 'Easy to Medium',
        'best_season' => 'November to February',
        'features' => [
            'Naval strategic importance',
            'Island locations in sea',
            'Boat access required',
            'Maritime architecture',
            'Offshore defense systems'
        ],
        'color' => 'bg-blue-100 dark:bg-blue-900'
    ],
    'Coastal Forts' => [
        'description' => 'Forts built along the coastline to protect ports and harbors',
        'icon' => 'fas fa-umbrella-beach',
        'difficulty_range' => 'Easy to Medium',
        'best_season' => 'November to February',
        'features' => [
            'Coastal strategic locations',
            'Harbor protection',
    ...
    'Forest Forts' => [
        'description' => 'Forts hidden in dense forests and jungle terrain',
        'icon' => 'fas fa-tree',
