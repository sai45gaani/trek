            ...
            <div class="swiper hero-swiper h-full">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide relative">
                        ...
                        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[0]['PIC_NAME']); ?>');"></div>
                    ...
                    <div class="swiper-slide relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-black/60 to-black/30 z-10"></div>
                        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[1]['PIC_NAME']); ?>');"></div>
                        <div class="relative z-20 h-full flex items-center justify-center text-center text-white px-4">
                            <div class="max-w-4xl">
                                <h1 class="text-5xl md:text-7xl font-bold mb-6">
                    ...
                    <?php if ($heroTrek): ?>
                                <div class="swiper-slide relative">
                                    ...
                                    <div class="absolute inset-0 bg-cover bg-center"
                                        style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[2]['PIC_NAME']); ?>');">
                                    </div>
                 ...
                 <?php if (!$heroTrek): ?>
                        <div class="swiper-slide relative">
                            ...
                            <!-- Background -->
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[3]['PIC_NAME']); ?>');">
                            </div>
                ...
                <?php endif; ?>
                    ...
                    <div class="swiper-slide relative">
                                ...
                                <div class="absolute inset-0 bg-cover bg-center"
                                    style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[3]['PIC_NAME']); ?>');"></div>
                    ...
                    <div class="swiper-slide relative">
                                    <div class="absolute inset-0 bg-black/70 z-10"></div>
                                    <div class="absolute inset-0 bg-cover bg-center"
                                        style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[4]['PIC_NAME']); ?>');"></div>
                    ...
                    <div class="swiper-slide relative">
                                    ...
                                    <div class="absolute inset-0 bg-cover bg-center"
                                        style="background-image: url('assets/images/Photos/Home/<?php echo htmlspecialchars($gallery_home_page[5]['PIC_NAME']); ?>');"></div>
                            ...
                            <?php while ($t = $treks->fetch_assoc()): ?>
                                ...
                                class="group block bg-white dark:bg-gray-800 rounded-2xl 
                                    ...
                                    <div class="p-6 flex flex-col h-full">
                                        ...
                                        <!-- Button LOOK only -->
                                        <span class="btn btn-primary w-full text-center 
                                                    pointer-events-none">
                                            View Trek
                                        </span>
