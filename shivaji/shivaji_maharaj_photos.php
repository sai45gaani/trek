...
$page_title = 'Photographs & Paintings of Shivaji Maharaj | TreKshitiZ';
$meta_description = 'Historic paintings, portraits, artistic depictions, and photographs of Chhatrapati Shivaji Maharaj.';
$meta_keywords = 'Shivaji Maharaj photos, Shivaji paintings, Shivaji portraits, Maratha history images';
    ...
    <div class="text-center max-w-5xl mx-auto">
        ...
        <!-- Title -->
         <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up mt-6">
            Shivaji Maharaj Photo Gallery
        </h1>

        <!-- Subtitle -->
       <p class="text-xl md:text-2xl mb-4 opacity-95">
            Historic Paintings, Portraits & Artistic Representations
        </p>

        <!-- Tagline -->
          <p class="text-lg md:text-xl mb-8 opacity-85">
            Visual legacy of the founder of Swarajya
        </p>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl md:text-5xl font-bold mb-6">
                <span class="bg-gradient-to-r from-red-600 to-yellow-500 bg-clip-text text-transparent">
                    Visual Legacy of Shivaji Maharaj
                </span>
            </h2>
            <p class="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
                A curated collection of historic paintings, portraits, and artistic depictions
                representing the valor, vision, and leadership of Chhatrapati Shivaji Maharaj.
            </p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            foreach ($photos as $i => $img) {
                echo "
                <div class='royal-card rounded-2xl overflow-hidden group cursor-pointer'
                     onclick='openPhoto($i)'>
                    ...
                    <div class='relative overflow-hidden'>
                        ...
                        <div class='absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent
                            ...
                            <span class='text-white text-sm tracking-wide flex items-center gap-2'>
