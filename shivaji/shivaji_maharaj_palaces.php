...
$page_title = 'Mahal – Palaces of Shivaji Maharaj | Royal Residences | Trekshitz';

$meta_description = 'Detailed information about the palaces (Mahal) of Chhatrapati Shivaji Maharaj, highlighting royal residences, administrative centers, architectural planning, and their role in the governance of Swarajya.';

$meta_keywords = 'Mahal of Shivaji Maharaj, Palaces of Shivaji Maharaj, Maratha palaces, Swarajya administration, royal residences, Shivaji architecture, Maratha governance';
  ...
  <div class="container mx-auto px-4 relative z-10">
    <div class="text-center max-w-5xl mx-auto">
      ...
      <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up mt-6">
        Mahal – Palaces of Chhatrapati Shivaji Maharaj
      </h1>

      <!-- Subtitle -->
      <p class="text-xl md:text-2xl mb-4 opacity-95">
        Royal Residences, Administrative Centers & Symbol of Swarajya
      </p>

      <!-- Tagline -->
      <p class="text-lg md:text-xl mb-8 opacity-85">
        Governance • Architecture • Royal Administration
      </p>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="text-center mb-16">
      ...
      <h2 class="text-4xl md:text-5xl font-bold mb-6">
        <span class="bg-gradient-to-r from-red-600 to-yellow-500 bg-clip-text text-transparent">
          Palaces of Shivaji Maharaj
        </span>
      </h2>
      <p class="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
        Functional royal complexes serving governance, security, and daily administration
      </p>
    </div>
    ...
    <div class="royal-card rounded-2xl p-8 md:p-12 max-w-6xl mx-auto bg-[#ECC783] border border-yellow-700">
      ...
      <p class="mb-10 text-justify text-lg">
        The palaces (Mahals) of Chhatrapati Shivaji Maharaj were not symbols of luxury,
        but carefully planned administrative and residential complexes. Each section
        within a Mahal served a defined purpose related to governance, security,
        logistics, and royal administration.
      </p>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <!-- Palace Units -->
        <div>
          <h3 class="text-xl font-semibold mb-3 border-b border-yellow-700 pb-2">
            <i class="fas fa-home text-red-600 mr-2"></i>
            Pote (Koshagar)
          </h3>
          <p class="text-justify">
            Treasury section used for storage of valuables and state resources.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="text-justify">
            Mint area associated with coin handling and monetary activities.
          </p>
        </div>

        <div>
          <h3 class="text-xl font-semibold mb-3 border-b border-yellow-700 pb-2">
            <i class="fas fa-cow text-green-700 mr-2"></i>
            Wadi (Goshala)
          </h3>
          <p class="text-justify">
            Cattle shelter supporting daily palace needs.
          </p>
        </div>

        <div>
          <h3 class="text-xl font-semibold mb-3 border-b border-yellow-700 pb-2">
            <i class="fas fa-door-open text-blue-700 mr-2"></i>
            Daruni (Antahpur)
          </h3>
          <p class="text-justify">
            Inner residential quarters with restricted access.
          </p>
        </div>

        <div>
          <h3 class="text-xl font-semibold mb-3 border-b border-yellow-700 pb-2">
            <i class="fas fa-horse text-purple-700 mr-2"></i>
            Paga (Ashwashala)
          </h3>
          <p class="text-justify">
            Stable for royal horses used for travel and military readiness.
          </p>
        </div>

        <div>
          <h3 class="text-xl font-semibold mb-3 border-b border-yellow-700 pb-2">
            <i class="fas fa-warehouse text-orange-700 mr-2"></i>
            Kothi (Grain Storage)
          </h3>
          <p class="text-justify">
            Secure storage of grains ensuring food supply during emergencies.
          </p>
        </div>
      ...
      <!-- Additional Units -->
      <div class="mt-12 border-t border-yellow-700 pt-6 text-justify">
        <p class="text-lg">
          Additional palace components included <strong>Palakhi, Saudagar (Trader area),
          Chhaban (Guard post), Rathshala (Chariot shed), Imarat (Construction unit)</strong>
          and other service-based structures — all contributing to a self-sufficient
          royal ecosystem.
        </p>
      </div>
      ...
      <div class="mt-10">
        <p class="font-medium text-lg text-justify">
          In essence, the Mahals of Shivaji Maharaj were centers of disciplined governance,
          strategic administration, and ethical leadership — reflecting Swarajya’s
          values rather than royal extravagance.
        </p>
      </div>
