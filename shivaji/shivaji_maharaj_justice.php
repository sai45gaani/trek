...
$page_title = 'Nyay-Niti – Justice Policy of Shivaji Maharaj | Judicial System | Trekshitz';
$meta_description = 'Detailed information about Nyay-Niti, the justice and judicial system of Chhatrapati Shivaji Maharaj, highlighting its principles, administration, public welfare focus, and historical significance.';
$meta_keywords = 'Nyay-Niti, Shivaji Maharaj justice policy, Maratha judicial system, Swarajya justice, dharma-based law, Shivaji administration';
    ...
    <div class="text-center max-w-5xl mx-auto">
        ...
        <!-- Title -->
         <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up mt-6">
          Nyay-Niti – Justice Policy of Chhatrapati Shivaji Maharaj
        </h1>

        <!-- Subtitle -->
        <p class="text-xl md:text-2xl mb-4 opacity-95">
          A Just, Humane & Dharma-based Judicial System of Swarajya
        </p>
        <!-- Tagline -->
         <p class="text-lg md:text-xl mb-8 opacity-85">
         Equality • Moral Governance • Welfare of the People
        </p>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="text-center mb-16">
      ...
      <h2 class="text-4xl md:text-5xl font-bold mb-6">
        <span class="bg-gradient-to-r from-red-600 to-yellow-500 bg-clip-text text-transparent">
          Justice Policy of Shivaji Maharaj
        </span>
      </h2>
      <p class="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
        Dharma-based, humane and people-centric justice system of Swarajya
      </p>
    </div>
    ...
    <div class="royal-card rounded-2xl p-8 md:p-12 max-w-6xl mx-auto bg-[#ECC783] border border-yellow-700">
      ...
      <p class="mb-6 text-justify text-lg">
        Shivaji Maharaj’s greatness is reflected not only in his military achievements
        but also in his exceptional justice policy. His governance was rooted in
        righteousness, moral discipline, and unwavering fairness.
      </p>

      <p class="mb-10 text-justify text-lg">
        Before the establishment of Swarajya, Maharashtra had suffered under arbitrary
        and oppressive rule. Shivaji Maharaj inherited the legacy of just governance
        from earlier Hindu rulers and transformed it into a people-centric judicial system.
      </p>
      ...
      <div class="grid md:grid-cols-2 gap-10">
        ...
        <div>
          <h3 class="text-2xl font-semibold mb-4 border-b border-yellow-700 pb-2">
            ...
            Justice for Public Welfare
          </h3>

          <p class="mb-4 text-justify">
            Shivaji Maharaj firmly believed that a ruler exists for the welfare of his
            subjects. Justice delivery under Swarajya was transparent, accessible,
            and humane.
          </p>

          <p class="text-justify">
            Justice was not limited to elites — common citizens, women, farmers,
            and the poor were equally protected. Social status never influenced
            judicial decisions.
          </p>
        </div>
        ...
        <div>
          <h3 class="text-2xl font-semibold mb-4 border-b border-yellow-700 pb-2">
            ...
            Dharma-based Judicial System
          </h3>

          <p class="mb-4 text-justify">
            Judicial decisions were based on Hindu Dharma principles, ethics,
            and moral law. Both civil and criminal cases were handled impartially.
          </p>

          <p class="text-justify">
            No discrimination was made on the basis of religion, caste, or community,
            and even high-ranking officials were punished if found guilty.
          </p>
        </div>
        ...
        <div>
          <h3 class="text-2xl font-semibold mb-4 border-b border-yellow-700 pb-2">
            ...
            Fearless & Impartial Justice
          </h3>

          <p class="mb-4 text-justify">
            Shivaji Maharaj ensured that justice prevailed over power.
            Authority or rank never shielded an offender from punishment.
          </p>

          <p class="text-justify">
            Judicial courage and moral clarity strengthened public trust
            in Swarajya’s administration.
          </p>
        </div>
        ...
        <div>
          <h3 class="text-2xl font-semibold mb-4 border-b border-yellow-700 pb-2">
            ...
            Ethical & Moral Governance
          </h3>

          <p class="mb-4 text-justify">
            Ethical values and social morality were actively protected
            through judicial decisions.
          </p>

          <p class="text-justify">
            The justice system became the moral backbone of Swarajya,
            ensuring harmony, discipline, and social stability.
          </p>
        </div>
      ...
      <div class="mt-12 border-t border-yellow-700 pt-6">
        <p class="font-medium text-lg text-justify">
          In conclusion, Shivaji Maharaj’s Nyay-Niti established a just, ethical,
          and welfare-oriented governance model that remains relevant even today
          and stands as one of the strongest pillars of Swarajya.
        </p>
      </div>
...
<section class="max-w-6xl mx-auto px-4 pb-20">
  <details open class="royal-card bg-[#FFF4D6] border border-yellow-700 rounded-2xl p-6">
    <summary class="cursor-pointer text-xl font-bold text-center hover:text-maratha">
      📜 Detailed Judicial & Administrative Notes
    </summary>

    <div class="mt-6 space-y-4 text-justify text-lg">

      <p>
        Chhatrapati Shivaji Maharaj enforced justice with absolute impartiality.
        Criminals were punished strictly regardless of rank, position, or influence.
        Justice was delivered fearlessly, without favoritism or hesitation.
      </p>

      <p>
        Judicial decisions actively protected ethical values and social morality.
        This approach ensured long-term stability, discipline, and harmony within society.
      </p>

      <p>
        The justice system of Swarajya served as its moral foundation,
        strengthening public trust in governance and reinforcing the ruler’s
        responsibility toward the welfare of the people.
      </p>
