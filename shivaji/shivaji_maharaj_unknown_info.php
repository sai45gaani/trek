...
$page_title = 'Rare & Unknown Facts of Chhatrapati Shivaji Maharaj | Historical Insights | Trekshitz';

$meta_description = 'Explore rare and lesser-known historical facts about Chhatrapati Shivaji Maharaj, including royal family details, Ashta-Pradhan Mandal, administration, lineage, and unique insights into the Maratha Empire.';

$meta_keywords = 'rare facts of Shivaji Maharaj, unknown information Shivaji Maharaj, Shivaji Maharaj family, Ashta Pradhan Mandal, Maratha administration, historical facts Shivaji, Swarajya history, Trekshitz';
  ...
  <div class="container mx-auto px-4 relative z-10">
    <div class="text-center max-w-5xl mx-auto">
      ...
      <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up">
        Rare & Lesser-known Facts of Chhatrapati Shivaji Maharaj
      </h1>

      <p class="text-xl md:text-2xl mb-4 opacity-95">
        Unknown Historical Facts, Royal Family & Administration of Swarajya
      </p>

      <p class="text-lg md:text-xl mb-8 opacity-85">
        Royal Lineage • Ashta-Pradhan Mandal • Historical Insights
      </p>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="royal-card rounded-2xl p-8 md:p-12 max-w-6xl mx-auto bg-[#ECC783] border border-yellow-700">
      ...
      <h2 class="text-3xl font-bold mb-6 text-center">
        Lesser-known Historical Information
      </h2>
      ...
      <p class="mb-4 text-justify">
        Chhatrapati Shivaji Maharaj had eight queens:
        Saibai, Soyarabai, Putalabai, Gunwantabai, Sagunabai,
        Kashibai, Laxmibai, and Sakvarbai.
      </p>
      ...
      <p class="mb-4 text-justify">
        His children included Sambhaji Maharaj, Sakhubai, Ranubai,
        Ambikabai, Rajaram Maharaj, Deepabai, Kamlabai, and Rajkunverbai.
      </p>
      ...
      <p class="mb-4 text-justify">
        The Ashta-Pradhan council consisted of eight ministers:
        Peshwa (Moropant Pingale), Amatya (Ramchandra Nilkanth),
        Sachiv (Annaji Datto), Mantri (Ramchandra Trimbak),
        Senapati (Hambirrao Mohite), Sumant (Dattaji Trimbak),
        Panditrao (Raghunath Pandit), and Nyayadhish (Niraji Raoji).
      </p>
      ...
      <p class="text-justify">
        Sambhaji Maharaj had two wives — Yesubai and Durgabai.
        Rajaram Maharaj’s wife Tarabai was the daughter of Senapati Hambirrao Mohite.
        Aurangzeb, a lifelong enemy of Shivaji Maharaj, was born in Gujarat and died in
        Maharashtra at the age of 89.
      </p>
