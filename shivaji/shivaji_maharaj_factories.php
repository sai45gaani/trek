...
$page_title = 'Karkhaane – Factories of Shivaji Maharaj | Industrial System | Trekshitz';

$meta_description = 'Detailed information about Karkhaane, the state-controlled factories of Chhatrapati Shivaji Maharaj, highlighting industrial organization, military and civil production units, economic administration, and their role in strengthening Swarajya.';

$meta_keywords = 'Karkhaane, Shivaji Maharaj factories, Maratha industrial system, Swarajya economy, state-controlled factories, military production, Shivaji administration';
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="text-center max-w-5xl mx-auto">
        ...
        <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up mt-6">
          Karkhaane – Factories of Chhatrapati Shivaji Maharaj
        </h1>

        <!-- Subtitle -->
        <p class="text-xl md:text-2xl mb-4 opacity-95">
          Industrial, Military & Administrative Backbone of Swarajya
        </p>

        <!-- Tagline -->
        <p class="text-lg md:text-xl mb-8 opacity-85">
          Self-reliance • Logistics • State Infrastructure
        </p>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="text-center mb-16">
      ...
      <h2 class="text-4xl md:text-5xl font-bold mb-6">
        <span class="bg-gradient-to-r from-red-600 to-yellow-500 bg-clip-text text-transparent">
          Factories (Karkhaane) of Shivaji Maharaj
        </span>
      </h2>
      <p class="text-xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
        Industrial, military, administrative and economic infrastructure of Swarajya
      </p>
    </div>
    ...
    <div class="royal-card rounded-2xl p-8 md:p-12 max-w-5xl mx-auto bg-[#ECC783] border border-yellow-700">
      ...
      <p class="mb-8 text-lg text-justify">
        Chhatrapati Shivaji Maharaj established a well-organized system of state-controlled
        factories known as <strong>Karkhaane</strong>. These institutions supported
        military preparedness, administration, healthcare, logistics, and royal governance,
        making Swarajya self-reliant and efficient.
      </p>
      ...
      <div class="grid md:grid-cols-2 gap-6 text-lg">
        ...
        <ul class="list-disc pl-6 space-y-2">
          <li><strong>Ratnashala:</strong> Treasury of precious gems</li>
          <li><strong>Ambar Khana:</strong> Royal wardrobe and elephant equipment store</li>
          <li><strong>Abdar Khana:</strong> Drinking water storage</li>
          <li><strong>Nobat Khana:</strong> Royal musical instruments</li>
          <li><strong>Talim Khana:</strong> Training and physical exercise center</li>
          <li><strong>Jamdar Khana:</strong> Weapon store</li>
          <li><strong>Jirayat Khana:</strong> Armory</li>
          <li><strong>Modi Khana:</strong> Food storage and kitchen</li>
          <li><strong>Sharbat Khana:</strong> Medical and medicinal store</li>
        </ul>

        <ul class="list-disc pl-6 space-y-2">
          <li><strong>Shikar Khana:</strong> Hunting and wildlife management</li>
          <li><strong>Darukhana:</strong> Ammunition and gunpowder store</li>
          <li><strong>Sheth Khana:</strong> Security equipment store</li>
          <li><strong>Pil Khana:</strong> Elephant stables</li>
          <li><strong>Faras Khana:</strong> Saddles, tents and equipment store</li>
          <li><strong>Uttar Khana:</strong> Camel stable</li>
          <li><strong>Top Khana:</strong> Cannon and artillery store</li>
          <li><strong>Daftar Khana:</strong> Administrative records office</li>
          <li><strong>Khazana:</strong> Cash treasury</li>
        </ul>
      ...
      <div class="mt-10 border-t border-yellow-700 pt-6">
        <p class="font-medium text-lg text-justify">
          These Karkhaane formed the backbone of Swarajya’s economy, defense, and governance,
          reflecting Shivaji Maharaj’s vision of a disciplined, self-sufficient state.
        </p>
      </div>
