                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="fortsGrid">
                            ...
                            class="block h-full focus:outline-none">
                                ...
                                <div class="fort-card rounded-2xl p-6 shadow-xl searchable-fort
                                            h-full flex flex-col hover:-translate-y-1 transition-all duration-300"
                                    ...
                                    <!-- HEADER: Fort Name (wrap) + Difficulty (right fixed) -->
                                    <div class="flex items-start gap-3 mb-4">
                                        <h3 class="text-xl font-bold text-gray-800 dark:text-white flex-1 break-words">
                                        ...
                                        ?>
                                        <span class="difficulty-badge <?php echo $difficultyClass; ?> shrink-0 whitespace-nowrap">
                                    ...
                                    <div class="space-y-2 mb-6">
                                        <div class="flex items-center text-gray-600 dark:text-gray-300 text-sm">
                                            <i class="fas fa-mountain text-accent mr-3 w-4 shrink-0"></i>
                                            <span class="break-words"><?php echo htmlspecialchars($fort['type']); ?></span>
                                        </div>

                                        <div class="flex items-center text-gray-600 dark:text-gray-300 text-sm">
                                            <i class="fas fa-map-marker-alt text-accent mr-3 w-4 shrink-0"></i>
                                            <span class="break-words"><?php echo htmlspecialchars($fort['district']); ?></span>
                                        </div>

                                        <?php if (!empty($fort['range']) && strtolower($fort['range']) != 'none'): ?>
                                        <div class="flex items-center text-gray-600 dark:text-gray-300 text-sm">
                                            <i class="fas fa-mountain text-accent mr-3 w-4 shrink-0"></i>
                                            <span class="break-words"><?php echo htmlspecialchars($fort['range']); ?></span>
                                        </div>
                                        <?php endif; ?>
                                    </div>

                                    <!-- CTA: pinned bottom & full width -->
                                    <div class="mt-auto">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function applyFilters() {
            ...
            fortCards.forEach(function(card) {
                ...
                const cardWrapper = card.closest('a'); // ✅ IMPORTANT
