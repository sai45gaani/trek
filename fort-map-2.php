        ...
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mt-8">
                    <button id="load-more" class="bg-accent hover:bg-primary text-white font-bold py-3 px-6 rounded-full transition-colors">
                        <i class="fas fa-plus mr-2"></i>Load More Forts
                    </button>
                </div>
            </div>
        </div>
