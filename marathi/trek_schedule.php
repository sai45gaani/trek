...
$page_title = 'ट्रेक वेळापत्रक - आगामी ट्रेक्स | ट्रेकशिट्झ';
$meta_description = 'ट्रेकशिट्झसोबत आगामी ट्रेक्सचा अनुभव घ्या. राजमाची, पेब, आद्राई आणि सह्याद्री पर्वतरांगांमधील इतर रोमांचक ठिकाणांसाठी आयोजित ट्रेक्समध्ये सहभागी व्हा.';
$meta_keywords = 'ट्रेक वेळापत्रक, आगामी ट्रेक्स, ट्रेकशिट्झ ट्रेक्स, महाराष्ट्र ट्रेकिंग, सह्याद्री ट्रेक्स, साहसी सहली';
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-5xl md:text-6xl font-bold mb-6">
                    ट्रेक <span class="text-accent">वेळापत्रक</span>
                </h1>
                <p class="text-xl md:text-2xl mb-8 opacity-90">
                    आगामी ट्रेक्स आणि साहसी उपक्रम
                </p>
                <p class="text-lg mb-8 opacity-80">
                     सुंदर सह्याद्री पर्वतरांगांमध्ये रोमांचक ट्रेक्ससाठी आमच्यासोबत सहभागी व्हा
                </p>
                ...
                <div class="flex flex-wrap justify-center gap-6 text-sm opacity-90">
                    <div class="flex items-center gap-2">
                        ...
                        <span><?php echo $total_treks_count; ?>आगामी ट्रेक्स</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <i class="fas fa-users text-accent"></i>
                        <span>नोंदणीसाठी खुला</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <i class="fas fa-mountain text-accent"></i>
                        <span>सर्व अवघडपणाच्या पातळ्या</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form method="GET" class="flex flex-col lg:flex-row gap-4 items-end">
                    ...
                    <div class="flex-1">
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                            <i class="fas fa-search mr-2"></i>ट्रेक शोधा
                        </label>
                        <div class="relative">
                            ...
                            <input 
                                ...
                                placeholder="ट्रेकचे नाव, लीडर किंवा वर्णनाद्वारे शोधा..."
                                autocomplete="off"
                            >
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-48">
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                            <i class="fas fa-signal mr-2"></i>अवघडपणा
                        </label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <?php if($trek['cost'] == 0): ?>
                                        <span class="text-sm text-gray-500 dark:text-gray-400 italic">
                                           खर्चाची माहिती मिळवण्यासाठी लीडरशी संपर्क साधा
                                        </span>
                                    <?php endif; ?>
                                </div>
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <a href="?" class="btn btn-primary inline-flex items-center px-6 py-3 bg-primary hover:bg-secondary text-white font-semibold rounded-lg transition-colors">
                        <i class="fas fa-refresh mr-2"></i>सर्व ट्रेक्स पहा
                    </a>
                </div>
            <?php endif; ?>
        </div>
