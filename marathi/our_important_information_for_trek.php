    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-800">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center text-gradient mb-12">
                मदत हवी आहे? आमच्या ट्रेक समन्वयकांशी संपर्क साधा
            </h2>
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div class="card bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-xl border border-gray-200 dark:border-gray-700 hover-lift">
                    ...
                    <h3 class="text-xl font-bold mb-3 text-gray-800 dark:text-white">फोन करा</h3>
                    <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                       आमच्या ट्रेक समन्वयकांशी थेट संवाद साधा
                    </p>
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-xl border border-gray-200 dark:border-gray-700 hover-lift">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                        जलद मदत व त्वरित प्रतिसादासाठी
                    </p>
                ...
                <div class="card bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-xl border border-gray-200 dark:border-gray-700 hover-lift">
                    ...
                    <h3 class="text-xl font-bold mb-3 text-gray-800 dark:text-white">ई-मेल</h3>
                    <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                       तुमचे प्रश्न व अभिप्राय आम्हाला पाठवा
                    </p>
