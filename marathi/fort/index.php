...
$page_title = 'किल्ल्याची सविस्तर माहिती | ट्रेकशितीज';
$meta_description = 'महाराष्ट्रातील किल्ल्यांची सविस्तर माहिती, ट्रेकिंग मार्गदर्शन आणि ऐतिहासिक वारसा जाणून घ्या';
$meta_keywords = 'महाराष्ट्र किल्ले, ट्रेकिंग, किल्ल्यांची माहिती, सह्याद्री किल्ले';
...
try {
    ...
    $query = "SELECT * FROM mi_tblfortinfo_unicode WHERE FortName LIKE ? LIMIT 1";
   // echo $query;
   // echo "<br>";
    ...
    if ($result->num_rows > 0) {
        ...
        if (!empty($fortData['FortRange']) && $fortData['FortRange'] != 'N/A') {
            $related_query = "SELECT FortName,FortNameMar, Grade,GradeMar,FortRange,FortRangeMar FROM mi_tblfortinfo_unicode WHERE FortRange = ? AND FortName != ? LIMIT 6";
...
background-position: center;">
        ...
        <div class="container mx-auto px-8 relative z-10">
            ...
            <div class="max-w-4xl">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">
                    <?php echo htmlspecialchars($fortData['FortNameMar']); ?>
                </h1>
                
                <div class="flex flex-wrap gap-3 mb-4">
                    <span class="px-4 py-2 bg-white bg-opacity-20 rounded-full text-sm font-semibold">
                        <i class="fas fa-fort-awesome mr-2"></i>
                        <?php echo htmlspecialchars($fortData['FortTypeMar']); ?>
                    </span>
                    <span class="px-4 py-2 bg-white bg-opacity-20 rounded-full text-sm font-semibold">
                        <i class="fas fa-map-marker-alt mr-2"></i>
                        <?php echo htmlspecialchars($fortData['FortDistrictMar']); ?>
                    </span>
                    <?php if (!empty($fortData['FortRange']) && $fortData['FortRange'] != 'N/A'): ?>
                        <span class="px-4 py-2 bg-white bg-opacity-20 rounded-full text-sm font-semibold">
                            <i class="fas fa-mountain mr-2"></i>
                            <?php echo htmlspecialchars($fortData['FortRangeMar']); ?>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700 text-center">
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">अवघडीनुसार स्तर</div>
                    <div class="font-bold text-gray-800 dark:text-white">
                        <span class="px-3 py-1 rounded-full text-white text-sm <?php echo getDifficultyColor($fortData['Grade']); ?>">
                            <?php echo htmlspecialchars($fortData['GradeMar']); ?>
                        </span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700 text-center">
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">समुद्रसपाटीपासून उंची</div>
                    <div class="font-bold text-gray-800 dark:text-white"><?php echo htmlspecialchars($fortData['HeightMar']); ?></div>
                </div>
                <?php //endif; 
                ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700 text-center">
                    <div class="text-3xl mb-2">⏱️</div>
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">ट्रेकसाठी लागणारा वेळ</div>
    ...
    : 'N/A'; ?></div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700 text-center">
                    <div class="text-3xl mb-2">🌤️</div>
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">सर्वोत्तम काळ</div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-4 left-4 z-10">
                            <span class="bg-accent text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                                <i class="fas fa-camera mr-2"></i>मुख्य छायाचित्र
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 text-center border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-4">सध्या कोणतेही नकाशे उपलब्ध नाहीत</p>
            ...
            <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-sky-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-sky-500">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-3">
                                <i class="fas fa-dove mr-2 text-sky-500"></i>पक्षी
                            </h3>
                        ...
                        <div class="bg-green-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-green-500">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-3">
                                <i class="fas fa-paw mr-2 text-green-500"></i>प्राणीजीवन
                            </h3>
                        ...
                        <div class="bg-pink-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-pink-500">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-3">
                                <i class="fas fa-seedling mr-2 text-pink-500"></i>वनस्पती
                            </h3>
                ...
                <div class="mb-12">
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-8 text-white text-center">
                        ...
                        <h3 class="text-2xl font-bold mb-4">स्थान नकाशे</h3>
                        <p class="mb-6 opacity-90">सविस्तर नकाशे व ट्रेकिंग मार्ग पहा</p>
                ...
                <div class="mb-12">
                    <h2 class="text-3xl font-bold mb-6 text-gray-800 dark:text-white flex items-center">
                        <span class="w-1 h-8 bg-accent mr-4"></span>
                        या परिसरातील इतर किल्ले <?php echo htmlspecialchars($fortData['FortRangeMar']); ?>
                    </h2>
    ...
    <section class="py-12 bg-gradient-to-r from-primary to-secondary text-white">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-3xl font-bold mb-8">तुमचा ट्रेक नियोजित करत आहात का?</h2>
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm">
                        ...
                        <h3 class="text-lg font-bold mb-2">साहित्य योग्यरीत्या पॅक करा</h3>
                        <p class="text-sm opacity-90">आवश्यक साहित्य, पाणी व प्राथमिक उपचार पेटी सोबत ठेवा</p>
                    </div>
                    
                    <div class="bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm">
                        <i class="fas fa-clock text-4xl mb-3 text-accent"></i>
                        <h3 class="text-lg font-bold mb-2">लवकर सुरुवात करा</h3>
                        <p class="text-sm opacity-90">सकाळी लवकर ट्रेक सुरू करा</p>
                    </div>
                    
                    <div class="bg-white bg-opacity-10 rounded-xl p-6 backdrop-blur-sm">
                        <i class="fas fa-users text-4xl mb-3 text-accent"></i>
                        <h3 class="text-lg font-bold mb-2">गटामध्ये ट्रेक करा</h3>
                        <p class="text-sm opacity-90">सुरक्षिततेसाठी नेहमी सहकाऱ्यांसोबत ट्रेक करा</p>
                    </div>
                </div>
