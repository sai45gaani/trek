...
<section class="max-w-7xl mx-auto px-4 py-16">
    <div class="bg-[#ECC783] border border-yellow-700 rounded-lg p-6">
        ...
        <h2 class="text-3xl font-bold text-center mb-8">
            Visual Legacy of Chhatrapati Shivaji Maharaj
        </h2>

        <p class="text-center max-w-4xl mx-auto mb-10">
            These images reflect the courage, leadership, and vision of Shivaji Maharaj.
            Each portrait represents the ideals of Swarajya, justice, and self-rule.
        </p>
