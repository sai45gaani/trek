...
$page_title = 'छत्रपती शिवाजी महाराजांवरील गीते व कविता | शिवगीत | ट्रेकशितीज';

$meta_description = 'छत्रपती शिवाजी महाराजांना समर्पित प्रेरणादायी शिवगीते, कविता, आरती, पोवाडे आणि भक्तिगीते यांचा समृद्ध संग्रह — जो शौर्य, स्वराज्य आणि राष्ट्रभक्तीची भावना जागवतो.';

$meta_keywords = 'छत्रपती शिवाजी महाराज गीते, शिवगीत, पोवाडा, शिवाजी महाराज कविता, शिवाजी महाराज आरती, मराठा गीते, स्वराज्य गीतसंग्रह';
  ...
  <div class="container mx-auto px-4 relative z-10">
    <div class="text-center max-w-5xl mx-auto">
      ...
      <h1 class="text-5xl md:text-7xl font-bold mb-6 font-devanagari">
        शिवभावनी – कवी भूषण यांचे काव्य
      </h1>

      <p class="text-xl md:text-2xl mb-4 opacity-95 font-devanagari">
        छत्रपती शिवाजी महाराजांची वीररसात्मक स्तुती
      </p>

      <p class="text-lg md:text-xl mb-8 opacity-85 font-devanagari">
        वीररस • ऐतिहासिक काव्य • साहित्यिक गौरव
      </p>
...
<section class="py-20 bg-white dark:bg-gray-900">
  <div class="container mx-auto px-4">
    ...
    <div class="royal-card bg-[#ECC783] border border-yellow-700 rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
      ...
      <h2 class="text-3xl font-bold text-center mb-10 font-devanagari">
        शिवभावनी (मूळ काव्य)
      </h2>

      <!-- 🔒 मूळ काव्य – कोणताही बदल नाही -->
      <div class="text-center font-devanagari text-lg leading-relaxed space-y-2">

        <!-- PASTE SAME ORIGINAL POEM HERE -->
        <!-- EXACT COPY -->
...
<section class="max-w-6xl mx-auto px-4 pb-20">
  <details open class="royal-card bg-[#FFF4D6] border border-yellow-700 rounded-2xl p-6">
    <summary class="cursor-pointer text-xl font-bold text-center hover:text-maratha font-devanagari">
      📜 शब्दार्थ व काव्याचा अर्थ
    </summary>

    <div class="mt-6 space-y-4 text-justify text-lg font-devanagari">

      <!-- 🔒 मूळ शब्दार्थ आणि स्पष्टीकरण -->
      <!-- जसंच्या तसं -->
