...
$page_title = 'मागील ट्रेक्स - पूर्ण झालेल्या साहसी मोहिमा | ट्रेकशिट्झ';
$meta_description = 'ट्रेकशिट्झसोबत पूर्ण झालेल्या ट्रेक्स आणि साहसी मोहिमांचा आढावा घ्या. सह्याद्री पर्वतरांगांमधील किल्ले, धबधबे आणि वारसा भ्रमंतीसह आम्ही भेट दिलेल्या अद्भुत ठिकाणांचा अनुभव घ्या.';
$meta_keywords = 'मागील ट्रेक्स, पूर्ण झालेले ट्रेक्स, ट्रेकशिट्झ साहसी मोहिमा, महाराष्ट्र ट्रेकिंग इतिहास, किल्ले मोहिमा, धबधबा ट्रेक्स';
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-5xl md:text-6xl font-bold mb-6">
                    मागील <span class="text-accent">साहसी मोहिमा</span>
                </h1>
                <p class="text-xl md:text-2xl mb-8 opacity-90">
                    आमच्या अद्भुत ट्रेक आठवणी पुन्हा जिवंत करा
                </p>
                <p class="text-lg mb-8 opacity-80">
                    महाराष्ट्र आणि त्यापलीकडील प्रदेशांमध्ये एकत्र पूर्ण केलेल्या अविस्मरणीय प्रवासांचा अनुभव घ्या
                </p>
                ...
                <div class="flex flex-wrap justify-center gap-4 text-sm opacity-90">
                    <a href="/trek-schedule" class="flex items-center gap-2 hover:text-accent transition-colors">
                        ...
                        <span>आगामी ट्रेक्स</span>
                    </a>
                    <span class="text-accent">•</span>
                    <span class="text-accent font-semibold">मागील साहसी मोहिमा</span>
                    <span class="text-accent">•</span>
                    <a href="/gallery" class="flex items-center gap-2 hover:text-accent transition-colors">
                        <i class="fas fa-images"></i>
                        <span>छायाचित्र संग्रह</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="text-center transform hover:scale-105 transition-transform">
                    ...
                    <div class="text-gray-600 dark:text-gray-300">पूर्ण झालेले ट्रेक्स</div>
                </div>
                <div class="text-center transform hover:scale-105 transition-transform">
                    ...
                    <div class="text-gray-600 dark:text-gray-300">एकूण सहभागी</div>
                </div>
                <div class="text-center transform hover:scale-105 transition-transform">
                    ...
                    <div class="text-gray-600 dark:text-gray-300">समाविष्ट श्रेणी</div>
                </div>
                <div class="text-center transform hover:scale-105 transition-transform">
                    <div class="text-4xl font-bold text-primary dark:text-accent mb-2 animate-number" data-target="8">0</div>
                    <div class="text-gray-600 dark:text-gray-300">भेट दिलेले राज्ये</div>
                </div>
            </div>
        </div>
    </section>
                ...
                <form method="GET" class="flex flex-col lg:flex-row gap-4 items-end">
                    ...
                    <div class="flex-1">
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                            <i class="fas fa-search mr-2"></i>मागील ट्रेक्स शोधा
                        </label>
                        <div class="relative">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="?" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg transition-colors">
                            <i class="fas fa-times mr-2"></i>क्लिअर
                        </a>
                    </div>
                </form>
            </div>
                                    ...
                                    <div class="space-y-2 mb-4">
                                        <div class="flex items-center justify-between text-sm">
                                            <div class="flex items-center text-gray-600 dark:text-gray-300">
                                                ...
                                                <?php echo htmlspecialchars($trek['location']); ?>
                                            </div>
                                        ...
                                        <div class="flex items-center text-gray-600 dark:text-gray-300 text-sm">
                                            ...
                                            नेतृत्व: <strong><?php echo htmlspecialchars($trek['leader']); ?></strong>
                                        </div>
                                    </div>

                                    <!-- Description -->
                                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed line-clamp-3 mb-6">
                                        <?php echo htmlspecialchars($trek['description']); ?>
                                    </p>

                                </div>

                                <!-- CTA + SHARE (ALWAYS BOTTOM) -->
                                <div class="flex gap-2 mt-auto">
                                    <a href="./trek-details.php?id=<?php echo $trek['id']; ?>"
                                    class="flex-1 bg-primary hover:bg-mountain text-white text-center py-2.5 px-3 rounded-lg font-semibold transition text-sm">
                                        <i class="fas fa-eye mr-1"></i>
                                        अधिक तपशील पहा
                                    </a>

                                    <button onclick="shareTrek(<?php echo $trek['id']; ?>, '<?php echo addslashes($trek['name']); ?>', '<?php echo $trek['date']; ?>')"
                                            class="bg-blue-600 hover:bg-blue-700 text-white py-2.5 px-3 rounded-lg font-semibold transition">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <h3 class="text-3xl font-bold text-gray-600 dark:text-gray-300 mb-4">
                        मागील ट्रेक्स आढळले नाहीत
                    </h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-8 text-lg">
                        सध्याच्या फिल्टर्सनुसार कोणतेही ट्रेक उपलब्ध नाहीत. कृपया शोध निकष बदला.
                    </p>
                    <a href="?" class="inline-flex items-center px-6 py-3 bg-forest hover:bg-mountain text-white font-semibold rounded-lg transition-colors">
                        <i class="fas fa-refresh mr-2"></i>सर्व मागील ट्रेक्स पहा
                    </a>
                </div>
            <?php endif; ?>
        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 rounded-2xl p-6 text-center shadow-xl border border-gray-200 dark:border-gray-700 hover-lift">
                            ...
                            <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                                <div class="flex items-center justify-center">
                                    ...
                                    <span><?php echo $stats['count']; ?>  पूर्ण झालेले ट्रेक्स</span>
                                </div>
                                <div class="flex items-center justify-center">
                                    <i class="fas fa-users mr-2 text-accent"></i>
                                    <span><?php echo $stats['participants']; ?> एकूण सहभागी</span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
