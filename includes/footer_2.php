<!-- Newsletter Section -->
    <section class="py-20 bg-gradient-nature text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <form class="max-w-md mx-auto flex" id="newsletter-form">
                <input type="email" name="email" placeholder="Enter your email" class="flex-1 px-6 py-3 rounded-l-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-accent" required>
                <button type="submit" class="bg-accent hover:bg-primary px-8 py-3 rounded-r-full font-semibold transition-colors">
                    Subscribe
                </button>
            </form>
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <p class="text-gray-300 mb-6 max-w-md leading-relaxed">
                        सह्याद्रीच्या सुंदर पर्वतांमध्ये ट्रेकिंगचा आनंद घ्या. आमच्यासोबत 350+ किल्ल्यांची माहिती मिळवा आणि निसर्गाच्या जवळ जा. Join our community of passionate trekkers and explore the magnificent Western Ghats.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="#home" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-home mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Home
                            </a>
                        </li>
                        <li>
                            <a href="#treks" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-hiking mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Upcoming Treks
                            </a>
                        </li>
                        <li>
                            <a href="forts.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-fort-awesome mr-2 group-hover:translate-x-1 transition-transform"></i>
                                किल्ल्यांची माहिती
                            </a>
                        </li>
                        <li>
                            <a href="gallery.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-images mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Photo Gallery
                            </a>
                        </li>
                        <li>
                            <a href="forum.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-comments mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Discussion Forum
                            </a>
                        </li>
                        <li>
                            <a href="gear.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="maps.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-map mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Maps (नकाशे)
                            </a>
                        </li>
                        <li>
                            <a href="articles.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-newspaper mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Articles
                            </a>
                        </li>
                        <li>
                            <a href="magazine.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-magazine mr-2 group-hover:translate-x-1 transition-transform"></i>
                                इ-मासिक
                            </a>
                        </li>
                        <li>
                            <a href="helpline.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-phone-alt mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Help Line
                            </a>
                        </li>
                        <li>
                            <a href="climbing.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-mountain mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Rock Climbing
                            </a>
                        </li>
                        <li>
                            <a href="sketches.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
                                <i class="fas fa-palette mr-2 group-hover:translate-x-1 transition-transform"></i>
                                Sketches
                            </a>
                        </li>
                        <li>
                            <a href="shivaji.php" class="text-gray-300 hover:text-accent transition-colors duration-300 flex items-center group footer-link">
            ...
            <div class="border-t border-gray-700 pt-8 mb-8">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                    ...
                    <div class="group">
                        <div class="text-3xl font-bold text-accent mb-2 group-hover:scale-110 transition-transform footer-stat" data-target="1000">0</div>
                        <div class="text-gray-400 text-sm">Trekkers</div>
                        <div class="text-xs text-gray-500">Community Members</div>
                    </div>
                    <div class="group">
                        <div class="text-3xl font-bold text-accent mb-2 group-hover:scale-110 transition-transform footer-stat" data-target="50">0</div>
                        <div class="text-gray-400 text-sm">Monthly Treks</div>
                        <div class="text-xs text-gray-500">Regular Adventures</div>
                    </div>
                    <div class="group">
                        <div class="text-3xl font-bold text-accent mb-2 group-hover:scale-110 transition-transform footer-stat" data-target="15">0</div>
                        <div class="text-gray-400 text-sm">Years Experience</div>
                        <div class="text-xs text-gray-500">Since 2010</div>
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-gray-700 pt-8">
                <div class="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                    ...
                    <div class="text-center lg:text-left">
                        <p class="text-gray-400 mb-2">
                            &copy; <?php echo date('Y'); ?> <span class="text-accent font-semibold">Trekshitz.com</span>. All rights reserved.
                        </p>
                        <p class="text-sm text-gray-500">
                            Made with <i class="fas fa-heart text-red-500 mx-1 animate-pulse"></i> for trekking enthusiasts | 
                            <span class="text-accent">Designed for Adventure</span>
                        </p>
                    </div>
                    ...
                    <div class="flex flex-wrap justify-center lg:justify-end space-x-6 text-sm">
                        <a href="privacy.php" class="text-gray-400 hover:text-accent transition-colors duration-300 hover:underline footer-link">
                            Privacy Policy
                        </a>
                        <a href="terms.php" class="text-gray-400 hover:text-accent transition-colors duration-300 hover:underline footer-link">
                            Terms of Service
                        </a>
                        <a href="cookies.php" class="text-gray-400 hover:text-accent transition-colors duration-300 hover:underline footer-link">
                            Cookie Policy
                        </a>
                        <a href="contact.php" class="text-gray-400 hover:text-accent transition-colors duration-300 hover:underline footer-link">
                            Contact Us
                        </a>
                        <a href="sitemap.php" class="text-gray-400 hover:text-accent transition-colors duration-300 hover:underline footer-link">
                            Sitemap
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-800">
                    <div class="flex flex-wrap justify-center items-center space-x-8 text-xs text-gray-500">
                        ...
                        <div class="flex items-center space-x-2">
                            <i class="fas fa-universal-access text-purple-500"></i>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Enhanced Footer script loaded');
        ...
        console.log('Enhanced Footer: All functionality initialized');
    });

    // Initialize footer functionality when main.js is loaded
    window.addEventListener('load', function() {
        // Additional initialization if needed
        console.log('Enhanced Footer loaded and initialized');
    });
    </script>
