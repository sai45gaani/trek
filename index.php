                   ...
                   <!-- <div class="swiper-slide relative">
                    ...
                    <?php if ($heroTrek): ?>
                        <div class="swiper-slide relative">
                            ...
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image:url('/assets/images/hero/trek-bg.jpg')"></div>

                            <div class="relative z-20 h-full flex items-center justify-center px-6">
                                <div class="max-w-4xl bg-white/90 backdrop-blur rounded-2xl p-8 text-center shadow-2xl">
                                    
                                    <span class="inline-block mb-4 px-4 py-1 text-sm font-semibold bg-accent text-black rounded-full">
                                        Upcoming Trek
                                    </span>
                                    ...
                                    <div class="flex justify-center gap-4">
                                        ...
                                        class="px-6 py-3 border border-primary text-primary rounded-lg font-semibold hover:bg-primary hover:text-white transition">
                                            Full Schedule
                                        </a>
                                    </div>
                                </div>
                    ...
                    <?php if (!$heroTrek): ?>
                        <div class="swiper-slide relative">
                            ...
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image:url('/assets/images/hero/no-trek-bg.jpg')"></div>

                            <div class="relative z-20 h-full flex items-center justify-center text-center px-6">
                                <div class="max-w-3xl text-white">

                                    <span class="inline-block mb-4 px-4 py-1 text-sm font-semibold bg-gray-200 text-black rounded-full">
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                        ...
                                        <a href="/gallery"
                                        class="px-6 py-3 bg-accent text-black font-bold rounded-lg hover:bg-primary hover:text-white transition">
                                            Explore Gallery
                                        </a>

                                        <a href="/contact"
                                        class="px-6 py-3 border border-white text-white rounded-lg font-semibold hover:bg-white hover:text-black transition">
                                            Get Notified
                                        </a>
                                    </div>
