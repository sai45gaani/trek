...
<div id="trek-modal"
    ...
    <div id="trek-modal-content"
         class="bg-white rounded-lg w-full max-w-2xl
...
<div class="space-y-4">
    ...
    <div class="flex justify-between items-center">
        ...
        <button onclick="openTrekModal('add')" class="bg-primary text-white px-4 py-2 rounded text-sm">
        ...
        <table class="min-w-full text-sm">
            ...
            <?php while ($r = $data->fetch_assoc()): ?>
                <tr>
                    ...
                    <button onclick="openTrekModal('view', <?= $r['TrekId'] ?>)" class="text-green-600">
                             <i class="fas fa-eye"></i>
                    </button>

                    <button onclick="openTrekModal('edit', <?= $r['TrekId'] ?>)" class="text-blue-600">
